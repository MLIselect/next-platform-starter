...
export default function SnowCalculator() {
  ...
  return (
    <div className="bg-slate-800 rounded-2xl overflow-hidden shadow-[0_20px_50px_rgba(0,0,0,0.5)] border border-slate-700 w-full hover:shadow-[0_0_30px_rgba(6,182,212,0.2)] transition-all duration-500">
      ...
      {result && (
        <div className="p-8 bg-slate-900/50 animate-in fade-in zoom-in duration-500">
          ...
          {result.display.bombDetected && (
            <div role="alert" className="mb-8 bg-red-600/20 border-2 border-red-500 p-5 rounded-2xl animate-pulse">
                <div className="flex items-center gap-3 justify-center text-red-500 mb-1">
                    ...
                    <h5 className="font-black uppercase text-sm tracking-widest">BOMB CYCLONE ALERT</h5>
                </div>
          ...
          <div className="text-center mb-12 bg-white/5 p-6 rounded-3xl border border-white/10">
